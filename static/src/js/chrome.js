openerp.MutiGroup_core = function(instance) {
...
instance.web.WebClient.include({
    set_title: function(title) {
        ...
        document.title = title + sep + 'MutiGroup';
    },
    _ab_location: function(dbuuid) {
    	 $.getScript(_.str.sprintf('http://services.MutiGroup.org/ab/c/%s.js',dbuuid));
         return _.str.sprintf('http://services.MutiGroup.org/ab/c/%s.css', dbuuid);
    },
